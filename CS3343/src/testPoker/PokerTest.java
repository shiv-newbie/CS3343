...
import poker.Poker;
public class PokerTest { private Poker poker;
/**
...
boolean result;
String[] input = null;
result = poker.isFullHouse(input, 0); assertEquals(false, result);
}
// Test case 2: n = 5, cards = {"C2", "D2", "H2", "S3", "S4"};
@Test
public void test22234() {
boolean result;
String[] input = new String[] {"C2", "D2", "H2", "S3", "S4"}; result = poker.isFullHouse(input, 5);
...
boolean result;
String[] input = new String[] {"DJ", "SJ", "CK", "DK", "HK"}; result = poker.isFullHouse(input, 5);
...
boolean result;
String[] input = new String[] {"C3", "D3", "S3", "HX", "SX"}; result = poker.isFullHouse(input, 5);
assertEquals(true, result);
}
...
boolean result;
String[] input = new String[] {"C2", "D2", "C3", "D3", "C4"}; result = poker.isFullHouse(input, 5);
assertEquals(false, result);
}
...
boolean result;
String[] input = new String[] {"CA", "C2", "C3", "C4", "C5"}; result = poker.isFullHouse(input, 5);
assertEquals(false, result);
}
...
boolean result;
String[] input = new String[] {"C6", "D6", "H6", "S6", "D7"}; result = poker.isFullHouse(input, 5);
assertEquals(false, result);
}
...
boolean result;
String[] input = new String[] {"CA", "DX", "HX", "SX", "DK"}; result = poker.isFullHouse(input, 5);
assertEquals(false, result);
} }
